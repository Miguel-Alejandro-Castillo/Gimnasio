        ...
        <c:forEach items="${productos}" var="producto">
          <tr id="row_${producto.id}">
            ...
            <td style="text-align: center;">
              <spring:url value="/productos/${producto.id}/detalle" var="urlProductoEditar" />
              <a href="${urlProductoEditar}">
                <button class="btn editButton"><i class="fas fa-info-circle"></i> Detalle Producto</button>
              </a>
              <spring:url value="/productos/${producto.id}/registrarStock" var="urlRegistrarStock" />
              <a href="${urlRegistrarStock}">
                <button class="btn editButton"><i class="fa fa-plus"></i>Registrar Stock</button>
              </a>
