    ...
    <div class="panel panel-default">
          ...
          <c:forEach items="${profesores}" var="profesor">
            <tr class="odd gradeX">
              ...
              <a href="${urlProfesorDetalle}"data-toggle="tooltip" title="Detalle" ><i class="fa fa-info-circle" style="font-size:24px;color:blue;padding-right: 10px;padding-left: 10px;"></i></a></td>
            </tr>
          </c:forEach>
          </tbody>
        </table>
